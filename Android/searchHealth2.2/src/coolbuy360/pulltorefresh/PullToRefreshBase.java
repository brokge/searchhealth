 ...
 *******************************************************************************/
package coolbuy360.pulltorefresh;
...
import coolbuy360.pulltorefresh.internal.FlipLoadingLayout;
import coolbuy360.pulltorefresh.internal.LoadingLayout;
import coolbuy360.pulltorefresh.internal.RotateLoadingLayout;
import coolbuy360.pulltorefresh.internal.Utils;
import coolbuy360.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final boolean isPullToRefreshOverScrollEnabled() {
		return VERSION.SDK_INT >= 9 && mOverScrollEnabled
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ?2
					: 0);
		}

...
public class NewsSub2 extends BaseFragment {
	...
	private NewListAdapter sub2NewAdapter = null;
	...
	public NewsSub2(Context context, NewListAdapter adapter) {
		mContext = context;
		sub2NewAdapter = adapter;
	}

	public NewsSub2(Context context, String articltype, String parentid) {
		mContext = context;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initPullToRefreshListView(refreshListView, sub2NewAdapter);		
		return view;
	}
	...
	public void initPullToRefreshListView(PullToRefreshListView rtflv,
		...
		if (sub2NewAdapter != null) {
			Log.i("newsub0", "sub2NewAdapter is not null oncreateview");
			if(headerView!=null)
			{
			rtflv.getRefreshableView().addHeaderView(headerView, null, false);
			}
			rtflv.setAdapter(sub2NewAdapter);
		} else {
			Log.i("newsub0", " sub2NewAdapter is null oncreateview");
		}
	...
	class GetNewsTask extends AsyncTask<String, Void, Integer> {
		...
		protected void onPostExecute(Integer result) {
			...
			case HTTP_REQUEST_SUCCESS:
				sub2NewAdapter.addNews(innerList);
				sub2NewAdapter.notifyDataSetChanged();
				break;
	...
	class MyOnRefreshListener2 implements OnRefreshListener2<ListView> {
		...
		public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
			...
			int count = sub2NewAdapter.getCount();
			if(count>0)
			{
			   bottomMap = (Map<String, String>) sub2NewAdapter
					.getItem(count - 1);
	...
	public void reLoadDataNoticeChange(List<Map<String, String>> ListData) {
		sub2NewAdapter.addNews(ListData);
		sub2NewAdapter.notifyDataSetChanged();
	}
	...
	public void addHeaderView(Map<String, String> headerMap,
		...
		refreshListView.getRefreshableView().addHeaderView(headerView, null,
				false);
		sub2NewAdapter = adapter;
		refreshListView.setAdapter(sub2NewAdapter);
	}
	...
	public void UPrefreshLoadData(View view, List<Map<String, String>> list) {
		...
		sub2NewAdapter.clearList();
		sub2NewAdapter.addNews(list);		
		sub2NewAdapter.notifyDataSetChanged();
	}

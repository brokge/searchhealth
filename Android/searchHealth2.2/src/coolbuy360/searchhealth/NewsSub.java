...
import coolbuy360.pulltorefresh.PullToRefreshBase.State;
/*import coolbuy360.searchhealth.NewsSub.GetDownNewsTask;
import coolbuy360.searchhealth.NewsSub.GetNewsTaskFrist;
import coolbuy360.searchhealth.NewsSub.GetUpNewsTask;
import coolbuy360.searchhealth.NewsSub.MyOnRefreshListener;
import coolbuy360.searchhealth.NewsSub.refreshOnclick;*/
import coolbuy360.service.CommandResult;
import coolbuy360.service.DisplayParams;
import coolbuy360.service.Util;

@SuppressLint("ValidFragment")
public class NewsSub extends BaseFragment {
	...
	public static NewsSub newsSubTest;
	public int Postion;
	...
	public NewsSub(Context context, String articltype, String parentid,
			int postion) {
		mContext = context;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (postionMap.get(Postion) == NO_LOADED) {				
			...
			new GetNewsTaskFrist(articleType, parentID, MoreNews.PageSize)
					.execute();
		}
	}
	...
	class MyOnRefreshListener implements OnRefreshListener2<ListView> {
		...
		public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
			...
			new GetDownNewsTask(mPtflv, MoreNews.PageSize, parentID, articleType)
					.execute();
			// 刷新数据后状态归原
			isCompleted = false;
		...
		public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
			...
			new GetUpNewsTask(mPtflv, MoreNews.PageSize, parentID, articleType,
					updatetime).execute();
	...
	class GetDownNewsTask extends AsyncTask<String, Void, Integer> {
		...
		protected void onPostExecute(Integer result) {
			...
			case HTTP_REQUEST_SUCCESS:
				MoreNews inews = MoreNews.getInstance();
				if (inews != null) {
